...
def populate_games_played(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('foos', '0008_auto_20170203_0308'),
    ]

    operations = [
        migrations.AddField(
            model_name='player',
            name='doubles_games_played',
            field=models.IntegerField(default=0),
        ),
        migrations.AddField(
            model_name='player',
            name='singles_games_played',
            field=models.IntegerField(default=0),
        ),
        migrations.AddField(
            model_name='team',
        ...
        migrations.RunPython(populate_games_played),
    ]
